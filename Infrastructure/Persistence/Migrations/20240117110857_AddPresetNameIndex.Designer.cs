...
{
    [DbContext(typeof(CroptorDbContext))]
    [Migration("20240117110857_AddPresetNameIndex")]
    partial class AddPresetNameIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Croptor.Domain.Presets.Preset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Croptor.Domain.Users.ValueObjects.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Croptor.Domain.Presets.Preset", b =>
                {
                    b.HasOne("Croptor.Domain.Users.User", null)
                        .WithMany("Presets")
